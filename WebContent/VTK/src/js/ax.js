    ...
    var AxMenu = function () {
        ...
        _proto.init = function init() {
            ...
            el.find("a").click(function () {
                ...
                $.cookie('ThisAxMenu', thismenu, { expires: 365000, path: '/' });
                var thisexpand = $(this).attr("aria-expanded");
                if(typeof($(this).attr("aria-expanded"))=="undefined"){
                    $.cookie('ThisExpand', 'false', { expires: 365000, path: '/' });
                }else{
                    $.cookie('ThisExpand', thisexpand, { expires: 365000, path: '/' });
                }

            });
            if (conf.cookie == true){
                var menuid ="#" + $.cookie('ThisAxMenu');
                if($.cookie('ThisExpand') == "true" ){
